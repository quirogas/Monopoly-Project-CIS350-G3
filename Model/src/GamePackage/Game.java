...
public class Game {
    ...
    public void buyProperty(PropertySquare property, Player owner, Player buyer) {
        //get property from bank,
        // give property from bank
        if (owner != null) {
            buyer.recieveProperty(owner.giveProperty(property));
        }else{
            buyer.recieveProperty(bank.giveProperty(property));
        }
